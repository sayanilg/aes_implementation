...
void mixColumn(unsigned char *column){
	...
	column[0] = 	galois_multiplication(2 , col_cpy[0]) ^
			galois_multiplication(3 , col_cpy[1]) ^
			galois_multiplication(1 , col_cpy[2]) ^
			galois_multiplication(1 , col_cpy[3])

	column[1] = 	galois_multiplication(1 , col_cpy[0]) ^
			galois_multiplication(2 , col_cpy[1]) ^
			galois_multiplication(3 , col_cpy[2]) ^
			galois_multiplication(1 , col_cpy[3])

	column[2] = 	galois_multiplication(1 , col_cpy[0]) ^
			galois_multiplication(1 , col_cpy[1]) ^
			galois_multiplication(2 , col_cpy[2]) ^
			galois_multiplication(3 , col_cpy[3])

	column[3] = 	galois_multiplication(3 , col_cpy[0]) ^
			galois_multiplication(1 , col_cpy[1]) ^
			galois_multiplication(1 , col_cpy[2]) ^
			galois_multiplication(2 , col_cpy[3])
}
...
void InvmixColumn(unsigned char *column){
	...
	column[0] = 	galois_multiplication(14 , col_cpy[0]) ^
			galois_multiplication(11 , col_cpy[1]) ^
			galois_multiplication(13 , col_cpy[2]) ^
			galois_multiplication(9 , col_cpy[3])

	column[1] = 	galois_multiplication(9 , col_cpy[0]) ^
			galois_multiplication(14 , col_cpy[1]) ^
			galois_multiplication(11 , col_cpy[2]) ^
			galois_multiplication(13 , col_cpy[3])

	column[2] = 	galois_multiplication(13 , col_cpy[0]) ^
			galois_multiplication(9 , col_cpy[1]) ^
			galois_multiplication(14 , col_cpy[2]) ^
			galois_multiplication(11 , col_cpy[3])

	column[3] = 	galois_multiplication(11 , col_cpy[0]) ^
			galois_multiplication(13 , col_cpy[1]) ^
			galois_multiplication(9 , col_cpy[2]) ^
			galois_multiplication(14 , col_cpy[3])
}
